...
# ---- PAGE CONFIG ----
st.set_page_config(
    page_title='EdgeRunner AI vs Peers | Analytics',
    layout='wide',
...
# ---- TITLE & INTRO ----
st.title("🧠 EdgeRunner AI vs the AI World")
st.markdown(
    """
...
with tabs[0]:
    ...
    st.markdown('<div class="caption-text">Each company’s funding is compared against its employee growth rate. EdgeRunner AI appears as a high-growth, well-funded outlier.</div>', unsafe_allow_html=True)
...
<div style="font-family: 'Segoe UI', 'Roboto', Arial, sans-serif; padding: 1.5em; background: rgba(36,36,36,0.82); border-radius: 18px; box-shadow: 0 2px 16px rgba(0,0,0,0.18);">
    ...
    <h3 style="color:#71fae9; font-size:1.38em; margin-bottom:0.45em; font-family: 'Fira Sans', Arial, sans-serif;">Why EdgeRunner AI?</h3>
    <p style="font-size:1.08em; color:#e4f6fa;">
        EdgeRunner AI sits at the intersection of <b>real-world ML, product innovation, and impact</b>—right where I want to be.<br>
        My analytical rigor, ML know-how, and energy can help unlock your data's full value and push the company’s vision to the next level.<br>
